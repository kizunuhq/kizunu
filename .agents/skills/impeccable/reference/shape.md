...
If the user already said "approved" or "go" during discovery for the _exact direction you'd present_, that counts as confirmation; you may proceed without asking again. But if your brief adds anything the user hasn't seen and approved, you must stop and confirm.
