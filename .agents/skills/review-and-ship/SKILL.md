...
description: Review the current branch for bugs, intent fit, and test coverage; run or write tests; commit focused work; open or update a PR. Use when finalizing changes before shipping, preparing a PR, or verifying a branch is ready to merge.
---
