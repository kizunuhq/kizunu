...
import { CadencesTable } from '@kizunu/web/routes/_app/workspace/cadences/-components/cadences-table'
import { TemplatesTable } from '@kizunu/web/routes/_app/workspace/cadences/-components/templates-table'
