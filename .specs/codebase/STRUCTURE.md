...
- `cadence` — the cadence aggregate. Today holds the `Template` sub-area (HSM-reference templates, workspace CRUD: create/list/update/delete); the `Cadence`/`Step` aggregate + `EntryTrigger` join here in feature `006`.
