 ...
 */
export type FieldContext<T extends object = Record<string, unknown>> = DeepPartial<
  Omit<T, keyof InternalFields>
> &
  InternalFields
...
type ExtractCatalogCodes<T> = T extends { readonly _codes: ReadonlyArray<infer C extends string> }
  ? C
  : never
